...
class EventsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('ems_event')->insert([
            ...
            [
                'id' => 13,
                'evn_title' => 'Cloud Infrastructure Webinar',
                'evn_category_id' => 2,
                'evn_description' => 'ให้ความรู้เรื่อง AWS, Docker, Kubernetes และการ Deploy บนระบบ Cloud',
                'evn_date' => '2026-02-23',
                'evn_timestart' => '14:00:00',
                'evn_timeend' => '16:30:00',
                'evn_duration' => 150,
                'evn_location' => 'Online - Microsoft Teams',
                'evn_file' => 'have',
                'evn_create_by' => 18,
                'evn_created_at' => now(),
                'evn_deleted_at' => null,
            ...
            [
                'id' => 14,
                'evn_title' => 'Data Analytics Workshop',
                'evn_category_id' => 3,
                'evn_description' => 'เวิร์กช็อปการวิเคราะห์ข้อมูลด้วย Python และ Tableau',
                'evn_date' => '2026-02-24',
                'evn_timestart' => '09:00:00',
                'evn_timeend' => '14:00:00',
                'evn_duration' => 300,
                'evn_location' => 'ห้องปฏิบัติการคณิตศาสตร์',
                'evn_file' => 'have',
                'evn_create_by' => 20,
                'evn_created_at' => now(),
                'evn_deleted_at' => null,
            ...
            [
                'id' => 15,
                'evn_title' => 'Customer Success Kickoff Meeting',
                'evn_category_id' => 4,
                'evn_description' => 'เปิดตัวโครงการใหม่สำหรับ Customer Success Team',
                'evn_date' => '2026-02-25',
                'evn_timestart' => '10:00:00',
                'evn_timeend' => '11:30:00',
                'evn_duration' => 90,
                'evn_location' => 'ห้องประชุม Marble',
                'evn_file' => 'have',
                'evn_create_by' => 23,
                'evn_created_at' => now(),
                'evn_deleted_at' => null,
            ...
            [
                'id' => 16,
                'evn_title' => 'Marketing Campaign Planning',
                'evn_category_id' => 1,
                'evn_description' => 'วางแผนแคมเปญการตลาดสำหรับไตรมาสที่ 2',
                'evn_date' => '2026-02-26',
                'evn_timestart' => '09:30:00',
                'evn_timeend' => '12:00:00',
                'evn_duration' => 150,
                'evn_location' => 'ห้องประชุม Creative Space',
                'evn_file' => 'not_have',
                'evn_create_by' => 26,
                'evn_created_at' => now(),
                'evn_deleted_at' => null,
            ...
            [
                'id' => 17,
                'evn_title' => 'Company Townhall Meeting',
                'evn_category_id' => 1,
                'evn_description' => 'ประชุมทั่วบริษัท เพื่อสรุปผลและแนวทางข้างหน้า',
                'evn_date' => '2026-02-28',
                'evn_timestart' => '15:00:00',
                'evn_timeend' => '16:30:00',
                'evn_duration' => 90,
                'evn_location' => 'บอลรูม โรงแรมฮิลตัน',
                'evn_file' => 'have',
                'evn_create_by' => 1,
                'evn_created_at' => now(),
                'evn_deleted_at' => null,
            ...
            [
                'id' => 18,
                'evn_title' => 'Legal Compliance Training',
                'evn_category_id' => 3,
                'evn_description' => 'อบรมการปฏิบัติตามกฎหมายและหลักเกณฑ์ของบริษัท',
                'evn_date' => '2026-03-02',
                'evn_timestart' => '10:00:00',
                'evn_timeend' => '12:30:00',
                'evn_duration' => 150,
                'evn_location' => 'ห้องบอลรูม B',
                'evn_file' => 'have',
                'evn_create_by' => 31,
                'evn_created_at' => now(),
                'evn_deleted_at' => null,
            ...
            [
                'id' => 19,
                'evn_title' => 'Team Building Activity',
                'evn_category_id' => 4,
                'evn_description' => 'กิจกรรมสนุก ๆ เพื่อเสริมสร้างความสามัคคีของทีม',
                'evn_date' => '2026-03-05',
                'evn_timestart' => '09:00:00',
                'evn_timeend' => '13:00:00',
                'evn_duration' => 240,
                'evn_location' => 'สวนสนุก Dream World',
                'evn_file' => 'not_have',
                'evn_create_by' => 2,
                'evn_created_at' => now(),
                'evn_deleted_at' => null,
            ...
            [
                'id' => 20,
                'evn_title' => 'Product Development Roadmap Review',
                'evn_category_id' => 1,
                'evn_description' => 'ทบทวนแผนงานพัฒนาผลิตภัณฑ์ 6 เดือนข้างหน้า',
                'evn_date' => '2026-03-07',
                'evn_timestart' => '13:00:00',
                'evn_timeend' => '15:00:00',
                'evn_duration' => 120,
                'evn_location' => 'ห้องประชุม Innovation Hub',
                'evn_file' => 'have',
                'evn_create_by' => 15,
                'evn_created_at' => now(),
                'evn_deleted_at' => null,
