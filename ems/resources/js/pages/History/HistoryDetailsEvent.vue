<!-- /**
 * ชื่อไฟล์: HistoryDetailsEvent.vue
 * คำอธิบาย: หน้าแสดงรายละเอียดของประวัติกิจกรรม (Event History Details)
 * Input: Event ID ผ่าน Route Parameter
 * Output: หน้าแสดงรายละเอียดกิจกรรม ข้อมูลไฟล์แนบ และรายชื่อผู้เข้าร่วมที่เลือกไว้ (Read-only)
...
export default {
  ...
  methods: {
     ...
     * คำอธิบาย: ดึงข้อมูลหมวดหมู่ทั้งหมด (รวมที่ถูกลบถ้า API รองรับ)
     * Input: -
     * Output: - (อัปเดต this.Categories)
     */
     ...
     * คำอธิบาย: ดึงข้อมูลรายละเอียดของกิจกรรมตาม ID
     * Input: Event ID
     * Output: - (อัปเดต this.form และ this.files)
     */
    async fetchEvent() {
      try {
        this.loading = true;
        ...
        const res = await axios.get(`/history/event/${id}`);
     ...
     * คำอธิบาย: ดึงรายชื่อพนักงานทั้งหมดเพื่อนำมาแสดงในตาราง
     * Input: -
     * Output: - (อัปเดต this.rows)
     */
