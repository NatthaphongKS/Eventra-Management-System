              ...
              <div class="flex flex-col gap-5">
                ...
                <FormField label="Employee ID" required>
                  <div class="grid grid-cols-2 gap-3 mt-1">
                    ...
                    <InputPill v-model="form.employeeNumber" placeholder="Ex.0001" maxlength="4" class="h-11 w-full"
                      :error="errors.employeeNumber" @input="onEmployeeNumberInput" />
                  </div>
                </FormField>
...
function validateField(key, value) {
  if (form.emp_permission === 'employee' && key === 'password') return ''
...
async function confirmSaveProcess() {
  ...
  try {
    ...
    if (res && res.status === 422 && res.data.errors) {
      ...
      if (apiErrors.emp_phone) { errors.emp_phone = 'This phone number is already in use.'; hasValidationError = true; }
      if (apiErrors.emp_email) { errors.emp_email = 'This email is already in use.'; hasValidationError = true; }
      ...
      else if (msg.includes('email')) errors.emp_email = 'This email is already in use.'
      else if (msg.includes('emp_id')) errors.employeeNumber = 'This employee ID is already in use.'
