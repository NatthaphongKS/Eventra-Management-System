                    ...
                    <tr class="bg-neutral-100 text-neutral-800">
                        <th v-if="selectable" class="w-10 py-3 text-center">
                            <input
                                ...
                                class="w-6 h-6 rounded border-gray-300 text-red-600 accent-red-600 focus:ring-0 cursor-pointer"
                            />
                        </th>
                        ...
                        >
                            <td v-if="selectable" class="px-2 py-2 text-center">
                                <input
                                    ...
                                    "
                                    class="w-6 h-6 rounded border-gray-300 text-red-600 accent-red-600 focus:ring-0 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                                />
                            </td>
