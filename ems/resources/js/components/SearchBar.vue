  ...
  <div class="flex items-end gap-3 w-full" v-bind="$attrs">
    <div class="flex-1 min-w-0">
      ...
      <input
        ...
        class="w-full h-[52px] px-4 rounded-[20px] border border-neutral-200 bg-white
    ...
    <button
      @click="emitSearch"
      class="w-[62px] h-[60px] flex items-center justify-center rounded-full bg-red-700 text-white transition-all duration-200 shadow-sm shrink-0"
      aria-label="Search"
      title="ค้นหา"
    >
