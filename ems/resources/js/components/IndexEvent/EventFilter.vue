...
<template>
    <div class="relative z-50 inline-block" ref="root">
        <button type="button" @click="isOpen = !isOpen"
            ...
            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2"
        ...
        <Transition enter-active-class="transition ease-out duration-150"
            ...
            <div v-show="isOpen"
                ...
                @click.stop>
                <div class="mt-[6px]">
                    <label class="flex items-center cursor-pointer hover:bg-gray-50 rounded-md transition-colors">
                        <input type="checkbox" class="accent-red-700 h-4 w-4 rounded border-gray-300 focus:ring-red-500"
                ...
                <div class="mt-[6px]">
                    ...
                    <div class="flex flex-col mt-[5px]">
                        <label v-for="c in categories" :key="c.id"
                            ...
                            <input type="checkbox" class="accent-red-700 h-4 w-4 rounded border-gray-300"
