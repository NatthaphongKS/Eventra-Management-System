...
const items = ref([
  ...
  },
  {
    ...
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="currentColor" d="M16 11h-1V3H9v8H8l4 4zm0-5h2v2h-2zm-4-3h2v2h-2zm0 5h2v2h-2zM8 8h2v2H8z"/></svg>`,
    children: [
