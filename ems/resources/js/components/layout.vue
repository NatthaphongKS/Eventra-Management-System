...
<template>
  <div class="min-h-screen bg-rose-50">
    <div class="grid min-h-screen grid-cols-[220px,1fr]">
      <!-- Sidebar -->
      <aside class="sticky top-0 z-30 flex h-[100dvh] rounded rounded-r-[20px] flex-col overflow-y-auto bg-white px-4 pt-5 shadow-lg">
        <!-- Brand -->
                            ...
                            <div v-show="expanded[item.to]"
                                ...
                                <RouterLink v-for="child in item.children" :key="child.to" :to="child.to"
                                    ...
                                    :class="isActive(child.to)
                                        ...
                                        : 'text-neutal-700 hover:bg-neutral-200'">
...
const items = ref([
    {
		...
		<path fill="#000" d="M6 19h3v-5q0-.425.288-.712T10 13h4q.425 0 .713.288T15 14v5h3v-9l-6-4.5L6 10zm-2 0v-9q0-.475.213-.9t.587-.7l6-4.5q.525-.4 1.2-.4t1.2.4l6 4.5q.375.275.588.7T20 10v9q0 .825-.588 1.413T18 21h-4q-.425 0-.712-.288T13 20v-5h-2v5q0 .425-.288.713T10 21H6q-.825 0-1.412-.587T4 19m8-6.75" />
	</svg>
`
    },
    {
		...
		<path fill="#000" d="M14.5 18q-1.05 0-1.775-.725T12 15.5t.725-1.775T14.5 13t1.775.725T17 15.5t-.725 1.775T14.5 18M5 22q-.825 0-1.412-.587T3 20V6q0-.825.588-1.412T5 4h1V2h2v2h8V2h2v2h1q.825 0 1.413.588T21 6v14q0 .825-.587 1.413T19 22zm0-2h14V10H5z" />
	</svg>
`
    },
    {
...
`
    },
    {
        ...
        to: '',
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
		<path fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3M3.223 14A9 9 0 1 0 12 3a9 9 0 0 0-8.294 5.5M7 9H3V5" />
	</svg>`,
        children: [
