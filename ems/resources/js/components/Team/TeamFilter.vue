...
export default {
    props: {
        ...
        // 1. เพิ่ม Props รับค่าจากตัวแม่
        isOpen: {
            type: Boolean,
            default: false
        }
    },
    emits: ["update:modelValue", "toggle"], // 2. เพิ่ม emit 'toggle'
    data() {
        return {
            // 3. ลบ isOpen ออกจากที่นี่ เพราะเราจะใช้จาก props แทน
            openKey: null,
        };
    },
    methods: {
        // 4. แก้ไขฟังก์ชัน toggle ให้ส่งสัญญาณไปหาตัวแม่
        toggle() {
            this.$emit('toggle');
            this.openKey = null;
        },
