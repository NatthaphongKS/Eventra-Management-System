<!-- /**
 * ชื่อไฟล์: PositionFilter.vue
 * คำอธิบาย: Filter component ของ Position (dropdown style ตามแบบ FilterEmployees)
 * Input: modelValue (filters), departments (options), teams (options)
    ...
    <div class="relative z-50" ref="filterBox">
        ...
        >
            ...
            >
                ...
                <!-- Team Filter -->
                <div v-if="teams && teams.length > 0" class="mb-4">
                    <label class="block text-sm font-medium text-neutral-800 mb-1 capitalize">
                        Team
                    </label>
...
export default {
    ...
    methods: {
        ...
        getSelectedLabel(key) {
            ...
            if (key === "team" && this.teams && selected.length === this.teams.length) {
                return "All";
            }
        ...
        toggleSelectAll(key) {
            ...
            if (key === "department") {
                ...
                options = this.teams.map((t) => String(t.id));
            }
