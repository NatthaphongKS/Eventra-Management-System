    ...
    <div>
        <div>
            ...
            <div class="date-detail">
                ...
                <div>กิจกรรมจัดขึ้นในวัน{{$dateStr}} เริ่มเวลา {{ $tstart }} - {{ $tend }} น. สถานที่ ณ {{$loc}}</div>
                <br>
            </div>
        ...
        <div>
            ...
            <div>
                <img src="{{ $message->embed(public_path('images/email/clicknext_logo.png')) }}" alt="Clicknext Logo"
